"""
Django settings for kartloop project.
...
ROOT_URLCONF = 'kartloop.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [BASE_DIR / 'templates'],  # ✅ FIXED location here
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'kartloop.wsgi.application'
...
NIMBUSPOST_API_URL = os.getenv("NIMBUSPOST_API_URL")
